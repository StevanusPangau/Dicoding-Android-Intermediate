...
import com.learn.submissionakhirstoryapp.data.local.room.RemoteKeys
import com.learn.submissionakhirstoryapp.data.local.room.StoryDatabase
import com.learn.submissionakhirstoryapp.data.local.room.StoryModel
...
class StoryRemoteMediator(
    ...
    override suspend fun load(
        ...
        try {
            ...
            val storyModels = responseData.listStory?.map { storyItem ->
                StoryModel(
                    id = storyItem?.id ?: "",
            ...
            database.withTransaction {
                ...
                val keys = responseData.listStory?.mapNotNull { storyItem ->
                    storyItem?.id?.let { id ->
                ...
                storyModels?.let { database.storyDao().insertStory(it) }
            }
